...
<details>
  ...
  <ul>
    <li>Antigravity 무료 계정(Starter Quota) 사용량 조회 복구: Antigravity 백엔드가 무료 계정에 5h 윈도우를 반환하지 않도록 API를 변경하면서 사용량 조회 전체가 조용히 실패하던 문제를 수정합니다. 이제 5h는 <code>--</code>로 표시되고, weekly(7d) 사용량은 정상적으로 표시됩니다.</li>
  </ul>
</details>
